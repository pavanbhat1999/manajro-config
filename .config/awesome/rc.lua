...
awful.rules.rules = {
    ...
    { rule = { class = "Brave-browser" }, properties = { screen = 1, tag = "2. ", switchtotag = true, maximized = true } }, -- space sensitive 😅
    ...
    { rule = { class = "mpv" },
        properties = { floating = true, width = 1080, height = 720, x = 500, y = 200, switchtotag = true, screen = 1,
            tag = "6. " } },
